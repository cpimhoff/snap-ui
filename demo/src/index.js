...
import {HStack, VStack, RStack, StackAlign, StackLayout, Box, Spacer} from '../../src';

const SimpleBox = (props) => <Box padding={10} textColor={props.bgColor && 'white'} {...props} />;
...
class Demo extends Component {
  render() {
    return <div>
      ...
      <h2>Boxes</h2>
      <Box>
        This is a box primitive with no style.
      </Box>
      ...
      <Spacer v={10}>
        <SimpleBox padding={10} borderRadius={10} shadow>
          This is a box primitive getting a little fancier with a shadow and all
        </SimpleBox>
      </Spacer>
      ...
      <RStack borderRadius={3}>
        ...
        <SimpleBox bgColor='green'>into a vertical layout on mobile</SimpleBox>
      </RStack>
      ...
      <HStack layout={StackLayout.centered} align={StackAlign.baseline} bgColor='lightgreen' padding={10}>
